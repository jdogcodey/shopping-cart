...
export default function Homepage() {
    return <main className='m-2 flex flex-col items-center justify-center flex-grow'>
        <div className='bg-[#4a90a4] p-5 md:p-10 rounded-lg text-lg md:text-7xl text-center'>
